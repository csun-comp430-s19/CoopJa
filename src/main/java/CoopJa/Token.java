...
public class Token {
    ...
    public enum TokenType {
        ...
        KEYWORD_THIS,KEYWORD_STATIC,KEYWORD_CLASS, KEYWORD_TRUE, KEYWORD_FALSE, KEYWORD_PRINTLN, KEYWORD_PRINTF, KEYWORD_NULL, KEYWORD_NEW, KEYWORD_ELSE,
        SYMBOL_PLUS,SYMBOL_MINUS,SYMBOL_ASTERISK,SYMBOL_SLASH, SYMBOL_BACKSLASH,SYMBOL_GREATERTHAN, SYMBOL_LESSTHAN,
        ...
        IDENTIFIER, NUMBER, STRING, UNKNOWN
    }
    ...
    private Map<String, TokenType> TOKEN_MAP =
            new HashMap<String, TokenType>() {{
                ...
                put("printf", TokenType.KEYWORD_PRINTF);
