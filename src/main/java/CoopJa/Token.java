...
public class Token {
    ...
    public enum TokenType {
        ...
        KEYWORD_PRIVATE,KEYWORD_PROTECTED,KEYWORD_BREAK,KEYWORD_RETURN,KEYWORD_WHILE,KEYWORD_FOR,KEYWORD_IF,KEYWORD_EXTENDS, KEYWORD_ELSE,
        KEYWORD_THIS,KEYWORD_STATIC,KEYWORD_NEW,SYMBOL_PLUS,SYMBOL_MINUS,SYMBOL_ASTERISK,SYMBOL_SLASH, SYMBOL_BACKSLASH,SYMBOL_GREATERTHAN, SYMBOL_LESSTHAN,
